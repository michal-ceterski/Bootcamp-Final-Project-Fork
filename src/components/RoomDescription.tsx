    ...
    return (
        ...
        <div>
            ...
            <div className="photos_container">
                <img className="add_image" src="https://cdn.pixabay.com/photo/2017/03/05/17/39/wi-fi-2119225_1280.png" alt="internet-icon"/><div>Free room Wi-Fi internet</div>
                <img className="add_image" src="https://image.freepik.com/darmowe-ikony/lodowka_318-10736.jpg" alt="fridge-icon"/><div>Refridgerator</div>
                <img className="add_image" src="https://th.bing.com/th/id/R.f5866a9e728c84ed2933d3dd31804fee?rik=rQy59MfHPnTEjA&pid=ImgRaw&r=0" alt="phone-icon"/><div>Telephone</div>
                <img className="add_image" src="https://image.freepik.com/darmowe-ikony/sylwetka-kropla-wody_318-37294.jpg" alt="water-icon"/><div>Free mineral water</div>
                <img className="add_image" src="https://i.pinimg.com/originals/fa/9a/8c/fa9a8c990be8c250c7966931a0c73893.png" alt="ac-icon"/><div>Air conditioning</div>
                <img className="add_image" src="https://mkdesk.pro/wp-content/uploads/2020/03/ikona-biurka-4.png" alt="desk-icon"/><div>Desk</div>
                <img className="add_image" src="https://t3.ftcdn.net/jpg/05/60/25/80/360_F_560258099_ky62cSILjBBhH0G8jgh3t2iPdiclDhmE.jpg" alt="towel-icon"/><div>Towels</div>
